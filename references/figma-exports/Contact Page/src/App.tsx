  ...
  return (
    <div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <nav
              ...
              data-id="166b2103-b605-5dc0-85ed-ac85fcc88522"
            >
              <a
                className="text-neutral-950 text-sm leading-5"
                href="#"
                data-id="0ee52ca1-5d16-57ec-8e78-e82667b4f369"
              >
                Home
              </a>
              <a
                className="text-neutral-950 text-sm leading-5"
                href="#"
                data-id="822fe684-a25a-551d-8263-7f1ef6dff4db"
              >
                About
              </a>
              <a
                className="text-neutral-950 text-sm leading-5"
                href="#"
                data-id="84f82221-961d-5e70-a377-2f673e2932a5"
              >
                Services
              </a>
              <a
                className="text-neutral-950 text-sm leading-5"
                href="#"
                data-id="e788f128-3609-5425-b22a-8b1ef8967011"
              >
                Branches
              </a>
              <a
                className="text-neutral-950 text-sm leading-5"
                href="#"
                data-id="9575eae3-4cbe-5e0b-81a3-3181051d6aa7"
              >
                Menu
              </a>
            </nav>
            <Button
              ...
              style={{ backgroundColor: "#C4714F" }}
              data-id="6c0a855c-0c12-59c3-bc38-189a41cec0c8"
            >
              Reserve a Table
            </Button>
          </div>
        ...
        <footer
          className="border-neutral-200 border-t-1 border-r-0 border-b-0 border-l-0 border-solid w-full"
          style={{ backgroundColor: "#FAF7F4" }}
          data-id="7f13aae0-0408-5940-a2e9-c87a24edf692"
        >
          <div
            className="max-w-[1140px] flex mx-auto px-8 py-6 justify-between items-center w-full"
            data-id="7963b04b-8e7f-5788-a2b4-b9af63a961b2"
          >
            <span
              className="text-neutral-500 text-xs leading-4"
              data-id="ec6c5ee2-fb12-53b5-af4c-d00c65a1a23a"
            >
            ...
            <nav
              ...
              data-id="0dd76bba-a0f8-5337-b67b-55c4f28c7ba8"
            >
              <a
                className="text-neutral-500 text-xs leading-4"
                href="#"
                data-id="1226c837-f5b7-58da-9bd0-75e69b81911f"
              >
                Privacy Policy
              </a>
              <a
                className="text-neutral-500 text-xs leading-4"
                href="#"
                data-id="1e28e788-2220-5827-8e57-dd83ee7bcdda"
              >
                Terms
              </a>
              <a
                className="text-neutral-500 text-xs leading-4"
                href="#"
                data-id="54609ba7-d116-5b5d-89d1-29521410940c"
              >
                Contact
              </a>
            </nav>
            <div
              ...
              data-id="4131e15d-c677-54d7-a2e8-f075ff5075e7"
            >
              <a
                aria-label="Facebook"
                href="#"
                style={{ color: "#2D6A4F" }}
                data-id="cf9a237a-a82e-51af-9ed7-c7a0e2cd4f38"
              >
                <FallbackComponent
                  className="size-4"
                  data-id="084bcb10-3556-55db-ac02-9e635648d666"
                />
              </a>
              <a
                aria-label="TikTok"
                href="#"
                style={{ color: "#2D6A4F" }}
                data-id="8b69044c-08ab-5c6b-a8ef-2ed6cf6e319e"
              >
                <Music2
                  className="size-4"
                  data-id="c657c7bd-d598-519f-a593-b885a68437bd"
                />
              </a>
              <a
                aria-label="WhatsApp"
                href="#"
                style={{ color: "#2D6A4F" }}
                data-id="15fbd9e9-ae01-5723-8f53-d8f8c6ab6b5f"
              >
                <MessageCircle
                  className="size-4"
                  data-id="03c421d1-ee29-5c3d-81ec-e06c92a930d3"
                />
              </a>
            </div>
          </div>
