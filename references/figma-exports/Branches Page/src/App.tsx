  ...
  return (
    <div>
      <div
        ...
        data-id="4a59f1b6-400c-5877-836a-aaf0634b0937"
      >
        <header
          className="sticky z-50 bg-white border-neutral-200 border-t-0 border-r-0 border-b-1 border-l-0 border-solid top-0 w-full"
          data-id="66f9c782-3c9e-53a6-bd76-b6ed59375d7b"
        >
          <div
            className="max-w-[1140px] flex mx-auto px-8 justify-between items-center w-full h-16"
            data-id="30087ac5-dc59-54c0-81a6-3bb5d2288f6c"
          >
            <div
              className="flex items-center gap-2"
              data-id="bf4425c0-5fa0-5cb8-a933-8c8c502520ab"
            >
              <div
                className="size-8 rounded-full flex justify-center items-center"
                style={{ backgroundColor: "#C4714F" }}
                data-id="74622f1e-ebf2-5273-b6a4-98791719111b"
              >
                <Leaf
                  className="size-4 text-white"
                  data-id="ae702be7-4d33-54cf-bbc6-147cae574502"
                />
              </div>
              <span
                className="font-medium text-lg leading-7 tracking-tight"
                data-id="c67881ab-f713-5aa2-b542-2794512f64f5"
              >
                Gaia AI
              </span>
            </div>
            <nav
              ...
              data-id="dcaf504d-0f40-5ec9-ba49-b52be614b2ef"
            >
              <a
                className="text-neutral-950/70 text-sm leading-5"
                href="#"
                data-id="5563c3b4-bf68-5522-8e2c-89af431b2692"
              >
                Home
              </a>
              <a
                className="text-neutral-950/70 text-sm leading-5"
                href="#"
                data-id="7b18c4ce-9ce5-5c01-8733-0cc2519db64c"
              >
                About
              </a>
              <a
                className="text-neutral-950/70 text-sm leading-5"
                href="#"
                data-id="a427d082-2583-579a-af54-3be227e6624d"
              >
                Services
              </a>
              <a
                ...
                data-id="5eedeb79-91af-5d3b-9940-6ea11b0502d3"
              >
                Branches
              </a>
              <a
                className="text-neutral-950/70 text-sm leading-5"
                href="#"
                data-id="6090316e-96f2-5b4b-b577-d21a8a8ad989"
              >
                Menu
              </a>
            </nav>
            <Button
              ...
              style={{ backgroundColor: "#C4714F" }}
              data-id="a2930f6a-7c7e-5561-a590-1064cd2784f5"
            >
              <CalendarCheck
                className="size-4"
                data-id="e9988b3d-2759-5781-8612-528c27727ae3"
              />
              Reserve a Table
            </Button>
          </div>
        ...
        <footer
          className="bg-white border-neutral-200 border-t-1 border-r-0 border-b-0 border-l-0 border-solid"
          data-id="6c1ad108-3115-5b79-b259-0f474eba8b25"
        >
          <div
            className="max-w-[1140px] flex mx-auto px-8 py-6 justify-between items-center w-full"
            data-id="acd1ef6e-2ed3-5dc0-995d-d3f8d4b308d8"
          >
            <span
              className="text-neutral-500 text-xs leading-4"
              data-id="3978703a-215b-5d5d-8a09-c152a05d152a"
            >
              © 2025 Gaia AI. All rights reserved.
            </span>
            <div
              className="flex items-center gap-6"
              data-id="f1128748-52ad-52a7-9865-75945721e6fb"
            >
              <a
                className="text-neutral-500 text-xs leading-4"
                href="#"
                data-id="5cce033c-146a-5f52-8781-a939ef34fce1"
              >
                Privacy
              </a>
              <a
                className="text-neutral-500 text-xs leading-4"
                href="#"
                data-id="39136f4c-a949-52f1-8b7b-57d99e5bb660"
              >
                Terms
              </a>
              <a
                className="text-neutral-500 text-xs leading-4"
                href="#"
                data-id="97802594-bd47-5a24-9097-c5739a8e5126"
              >
                Contact
              </a>
            </div>
            <div
              ...
              data-id="add0e205-033b-551e-974a-9ba81715d3a6"
            >
              <a
                aria-label="Facebook"
                className="size-8 rounded-full border-black/1 border-1 border-solid flex justify-center items-center"
                href="#"
                style={{ borderColor: "#2D6A4F", color: "#2D6A4F" }}
                data-id="7c626055-e02e-52bf-aad5-a6fe354c1c3a"
              >
                <FallbackComponent
                  className="size-4"
                  data-id="588e348a-9c36-57dc-9e1e-a3c5cf29e43c"
                />
              </a>
              <a
                aria-label="TikTok"
                ...
                href="#"
                style={{ borderColor: "#2D6A4F", color: "#2D6A4F" }}
                data-id="471ae01a-3fe8-5ded-8792-a1489bc6b449"
              >
                <Music2
                  className="size-4"
                  data-id="f5e3f985-1f79-58f2-960b-380cb560950e"
                />
              </a>
              <a
                aria-label="WhatsApp"
                ...
                href="#"
                style={{ borderColor: "#2D6A4F", color: "#2D6A4F" }}
                data-id="8232b106-e2fb-58d2-943c-ee6037eba3dd"
              >
                <MessageCircle
                  className="size-4"
                  data-id="5b9e0973-e212-50e4-bd40-4a4b5aabae21"
                />
              </a>
            </div>
          </div>
