  ...
  return (
    <div>
      <div
        ...
        data-id="cd5fe328-7afb-5e10-9736-f893dc90b729"
      >
        <header
          ...
          data-id="7a43b68e-dcae-57cf-a122-0d04518cb247"
        >
          <div
            className="flex mx-auto px-12 py-4 justify-between items-center"
            style={{ maxWidth: "1140px" }}
            data-id="669cfa65-bf4b-5a82-9479-032817e7a082"
          >
            <div
              className="flex items-center gap-2"
              data-id="75621af3-632a-53e3-8ab0-cd789775d587"
            >
              <div
                className="size-8 rounded-full flex justify-center items-center"
                style={{ backgroundColor: "#C4714F" }}
                data-id="ea760688-de59-53f3-a945-c04e95a0699e"
              >
                <Leaf
                  className="size-4 text-white"
                  data-id="a17191c3-5733-5bf5-918a-2250184cd68f"
                />
              </div>
              <span
                className="font-medium text-lg leading-7 tracking-tight"
                style={{ color: "#1F1B16" }}
                data-id="f85cdfe9-6f24-5468-9521-c8d1dacb181d"
              >
                Gaia AI
              </span>
            </div>
            <nav
              ...
              data-id="3545ed9a-d79f-5e1f-8b53-b1c963837ee6"
            >
              <a
                className="font-normal text-sm leading-5"
                href="#"
                style={{ color: "#5C5247" }}
                data-id="cabf6359-b0f3-50ce-b40a-d89a49ce3cdb"
              >
                Home
              </a>
              <a
                ...
                href="#"
                style={{ color: "#5C5247" }}
                data-id="6a1f72e2-1ed5-58e4-9017-634eed7032a6"
              >
                About
              </a>
              <a
                ...
                href="#"
                style={{ color: "#5C5247" }}
                data-id="48157867-73a7-5dab-b540-9c6cddcea8f5"
              >
                Services
              </a>
              <a
                ...
                href="#"
                style={{ color: "#5C5247" }}
                data-id="04f07aef-a99e-52dd-bd48-4fc4b8066dcd"
              >
                Branches
              </a>
              <a
                ...
                data-id="33e32fe9-c091-5dd6-a3d8-3984009f5548"
              >
                Menu
              </a>
            </nav>
            <Button
              ...
              style={{ backgroundColor: "#C4714F" }}
              data-id="227345b3-433e-529d-8ac5-13d2881fb468"
            >
              <CalendarCheck
                className="size-4 mr-2"
                data-id="4482a12f-bc7d-5b0f-b4f5-7538eeb6a49c"
              />
              Reserve a Table
            </Button>
          </div>
        ...
        <footer
          ...
          style={{ backgroundColor: "#FAF7F4", borderColor: "#E8E2DC" }}
          data-id="e1fe7425-703a-542b-aa7c-48a84e95c00e"
        >
          <div
            className="flex mx-auto px-12 py-6 justify-between items-center"
            style={{ maxWidth: "1140px" }}
            data-id="bf209e7e-926f-5a0c-a487-9e4959580e8a"
          >
            <p
              className="text-xs leading-4"
              style={{ color: "#5C5247" }}
              data-id="6bd2c8ed-4c91-5e7a-9d8c-d5dba8084b37"
            >
              © 2025 Gaia AI. All rights reserved.
            </p>
            <div
              className="text-xs leading-4 flex items-center gap-6"
              style={{ color: "#5C5247" }}
              data-id="e2934592-1fa0-5a0b-ad79-387f313fefc9"
            >
              <a href="#" data-id="002bac4c-9696-5995-9b26-3d3f7a940ab6">
                Privacy
              </a>
              <a href="#" data-id="57aa0368-eef5-5a1b-834c-53f2f87baf08">
                Terms
              </a>
              <a href="#" data-id="bee482de-17c1-57d8-ba0e-d47aa91c63ea">
                Contact
              </a>
            </div>
            <div
              className="flex items-center gap-3"
              data-id="ef0db54f-7ac5-58cb-9b49-d72c3f25cf92"
            >
              <a
                aria-label="Facebook"
                className="size-8 rounded-full flex justify-center items-center"
                ...
                data-id="95f69908-2169-5949-892b-fa195a9c2b9c"
              >
                <FallbackComponent
                  className="size-4"
                  style={{ color: "#2D6A4F" }}
                  data-id="f8eed3aa-7f58-5998-bea0-d10658ce9221"
                />
              </a>
              <a
                aria-label="TikTok"
                ...
                href="#"
                style={{ backgroundColor: "#E6F0EA" }}
                data-id="9d1a72eb-6b6c-559e-b2ab-a5309a8709b2"
              >
                <Music2
                  className="size-4"
                  style={{ color: "#2D6A4F" }}
                  data-id="12428adf-e0b8-523e-b943-55c6d4532087"
                />
              </a>
              <a
                aria-label="WhatsApp"
                ...
                href="#"
                style={{ backgroundColor: "#E6F0EA" }}
                data-id="6d8d63b4-467e-55e3-9cc1-f94e64c5c30d"
              >
                <MessageCircle
                  className="size-4"
                  style={{ color: "#2D6A4F" }}
                  data-id="6f6905df-c693-5157-a778-92ee1e174f5a"
                />
              </a>
            </div>
          </div>
