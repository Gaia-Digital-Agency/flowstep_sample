  ...
  return (
    <div>
      <div
        ...
        data-id="ba99872e-d31e-5359-8271-99b1b95440f3"
      >
        <header
          className="sticky z-50 border-neutral-200 border-t-0 border-r-0 border-b-1 border-l-0 border-solid top-0 w-full"
          style={{ backgroundColor: "#FAF7F4" }}
          data-id="aa323b15-1a5c-5d84-afbf-a869d08c6fa6"
        >
          <div
            className="max-w-[1140px] flex mx-auto px-8 justify-between items-center h-16"
            data-id="1a584bdf-91f6-50be-b468-43731f5934fc"
          >
            <div
              className="flex items-center gap-2"
              data-id="7f60b44d-929c-5d40-a3a2-bd114e682ad7"
            >
              <div
                className="size-8 rounded-full flex justify-center items-center"
                style={{ backgroundColor: "#C4714F" }}
                data-id="b4a7de75-25f4-52b5-be98-7cc8e41eaae2"
              >
                <Leaf
                  className="size-4 text-white"
                  data-id="6293d4a9-1650-5519-90bd-e46959763601"
                />
              </div>
              <span
                className="font-medium text-lg leading-7 tracking-tight"
                style={{ color: "#1A1A1A" }}
                data-id="b01dfc98-4597-5bc7-bd81-4049dfa2df3f"
              >
                Gaia
              </span>
            </div>
            <nav
              ...
              data-id="0b7e9297-9cb2-5cb7-aec7-02d1bcd35c2b"
            >
              <a
                className="text-sm leading-5"
                href="#"
                style={{ color: "#1A1A1A" }}
                data-id="9db80b97-2131-563b-abc6-b72d1bc0238f"
              >
                Home
              </a>
              <a
                ...
                data-id="03f89eae-cd4a-5881-9589-bd3414b9d336"
              >
                About
              </a>
              <a
                ...
                href="#"
                style={{ color: "#1A1A1A" }}
                data-id="e965bf64-e944-56ff-abf6-41b3c5e62d49"
              >
                Services
              </a>
              <a
                ...
                href="#"
                style={{ color: "#1A1A1A" }}
                data-id="d791735a-716d-511a-8e77-c0946e3563a9"
              >
                Branches
              </a>
              <a
                ...
                href="#"
                style={{ color: "#1A1A1A" }}
                data-id="543a880c-e877-5c0e-bbf3-41f4303d6edf"
              >
                Menu
              </a>
            </nav>
            <Button
              ...
              style={{ backgroundColor: "#C4714F" }}
              data-id="68b07e02-72c2-5a7e-bae2-933cd61ac6f6"
            >
              Reserve a Table
            </Button>
          </div>
        ...
        <footer
          ...
          style={{ backgroundColor: "#FAF7F4" }}
          data-id="9c6759bb-fd53-510b-81b2-4bc8c5ed642a"
        >
          <div
            className="max-w-[1140px] flex mx-auto px-8 py-6 justify-between items-center"
            data-id="ab5349aa-7aa0-5fe9-adf2-74f6d4f5cc8c"
          >
            <p
              className="text-neutral-500 text-xs leading-4"
              data-id="a2fe0bb8-0694-55c6-9874-87e4bd9b3ea0"
            >
              © 2025 Gaia. All rights reserved.
            </p>
            <div
              className="flex items-center gap-6"
              data-id="31500003-ce46-5d41-8d69-07e286085c89"
            >
              <a
                className="text-xs leading-4"
                href="#"
                style={{ color: "#1A1A1A" }}
                data-id="bdf715fb-dae2-54bf-a85f-9e0d78aab304"
              >
                Privacy
              </a>
              <a
                ...
                href="#"
                style={{ color: "#1A1A1A" }}
                data-id="fdaa0153-a6fe-58dc-ac47-81abf252304c"
              >
                Terms
              </a>
              <a
                ...
                href="#"
                style={{ color: "#1A1A1A" }}
                data-id="dd25dbc6-dbfe-5eaa-b6e6-a0dba507223d"
              >
                Contact
              </a>
            </div>
            <div
              ...
              data-id="fbc749ff-2cc1-56ff-bb3e-e75f222ea239"
            >
              <a
                aria-label="Facebook"
                href="#"
                data-id="a8559b3b-addb-5bc8-8ca6-98fdf57700ae"
              >
                <FallbackComponent
                  className="size-4"
                  fill="#2D6A4F"
                  style={{ color: "#2D6A4F" }}
                  data-id="0898615a-5906-568e-9c04-56131a16aa45"
                />
              </a>
              <a
                aria-label="TikTok"
                href="#"
                data-id="d726874e-6ef0-5741-966a-3cd4f119d561"
              >
                <Music2
                  className="size-4"
                  fill="#2D6A4F"
                  style={{ color: "#2D6A4F" }}
                  data-id="4936cf21-2bfa-50b8-a84b-93e679f4e013"
                />
              </a>
              <a
                aria-label="WhatsApp"
                href="#"
                data-id="9be5016f-b96f-513b-a5c6-4a50cd94e6af"
              >
                <MessageCircle
                  className="size-4"
                  fill="#2D6A4F"
                  style={{ color: "#2D6A4F" }}
                  data-id="c5501659-50ed-5b12-a186-1ee57eac4384"
                />
              </a>
            </div>
          </div>
